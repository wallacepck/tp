...
The command line remembers up to 16 previous commands. You can use the Up Arrow (↑) to scroll back through them and the Down Arrow (↓) to move forward. This saves time by letting you reuse commands without retyping them.
