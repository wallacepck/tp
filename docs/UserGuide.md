...
Format: `add n/NAME p/PHONE_NUMBER e/EMAIL [t/TAG] m/MODULE…​`
...
* `add n/Betsy Crowe t/friend e/betsycrowe@example.com a/Newgate Prison p/1234567 t/criminal m/CS2103T`
...
|------------|------------------------------------------------------------------------------------------------------------------------------------------|
| **Add**    | `add n/NAME p/PHONE_NUMBER e/EMAIL [t/TAG] m/MODULE…​` <br> e.g., `add n/James Ho p/22224444 e/jamesho@example.com t/friend t/colleague` |
| **Clear**  | `clear`                                                                                                                                  |
