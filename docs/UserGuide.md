...
| `m/`       | Module (can have multiple) | `m/CS2103T m/CS2101`                | Not used in `find`. See [Accepted Modules](#accepted-modules) for a list of valid module codes.                                                                                                                                                                                                                                                                                                                                                         |
| `f/`       | Favourite                  | `f/y` or `f/n`                      | Not used in `add` or `edit`. Only accepts `y` or `n`.                                                                                                                                                                                                                                                                                                                        |
| `mm/`      | Module(s)                  | `mm/CS2103T` or `mm/CS2101 CS2103T` | Not used in `add` or `edit`. See [Accepted Modules](#accepted-modules) for a list of valid module codes.                                                                                                                                                                                                                                                                                                                                                |
