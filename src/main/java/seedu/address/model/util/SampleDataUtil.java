    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                Role.TA, getModuleSet("CS2030S"), getTelegram("@sourceacademy")),
            new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                Role.PROFESSOR, getModuleSet("CS2100"), getTelegram("@sourceacademy")),
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                Role.TA, getModuleSet("CS2106"), getTelegram("@sourceacademy")),
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                Role.PROFESSOR, getModuleSet("CS2109S"), getTelegram("@sourceacademy")),
            new Person(new Name("Fernandez Keith"), new Phone("90900808"), new Email("fernk@example.com"),
                Role.TA, getModuleSet("CS3230"), getTelegram("@sourceacademy")),
            new Person(new Name("Ishizawa Naoru"), new Phone("83221199"), new Email("naoishi@example.com"),
                Role.PROFESSOR, getModuleSet("CS2101"), getTelegram("@sourceacademy"))
        };
    }
